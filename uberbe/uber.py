...
def add_tweet():
    ...
    travel_date = request.json['travel_date']
...
@app.route("/")
def home():
    return """Welcome to online Uber for Buses!<br />
        <br />
        Run the following endpoints:<br />
        From collection:<br/>
        http://18.215.49.36:5000/book<br />
        http://18.215.49.36/:5000/bookings-results<br />
        """
